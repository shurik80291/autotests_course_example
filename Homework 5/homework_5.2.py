...
def repeats(our_str):
    """
    Считаем сколько раз каждый символ уже встречался в строке
    :param our_str: исходная строка
    :return: новая строка, в которой подсчитано сколько раз каждый символ уже встречался в исходной строке
    """
    new_str = ''
