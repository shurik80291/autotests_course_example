...
class PublicTransport:
    def __init__(self, brand, engine_power, year, color, max_speed):
        """
        Атрибуты класса PublicTransport
    ...
    def info(self):
        ...
        :return: печать информации о транспорте
        """
        return print(f'Марка: {self.brand}\n'
                     f'Цвет: {self.color}\n'
                     f'Год выпуска: {self.year}\n'
                     f'Мощность: {self._engine_power}')
...
class Bus(PublicTransport):
    ...
    def park(self):
        """
        Свойство, которое возвращает значение park
        :return: значение атрибута park
        """
        return self.__park
    ...
    def park(self, park):
        """
        Свойство, которое устанавливает новое значение park, если оно в диапазоне от 1000 до 9999
        :param park: Парк приписки автобуса
        """
